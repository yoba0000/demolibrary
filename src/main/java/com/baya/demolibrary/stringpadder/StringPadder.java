...
/**
 * Pads a {@link String}
 * <p>The instances of classes that implement this interface are thread-safe and immutable</p>
 */
public interface StringPadder {
    /**
     * Returns a new {@link String} that right-alligns the characters in the specified String by padding them with spaces
     * on the left, for a specified total length
     * @param stringToPad the {@link String} to be padded
     * @param totallength the {@link String} to be padded
